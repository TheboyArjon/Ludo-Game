...
constexpr auto qt_meta_stringdata_CLASSTrackENDCLASS = QtMocHelpers::stringData(
    "Track",
    "pawnSelected",
    "",
    "Pawn*",
...
void Track::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->pawnReturned((*reinterpret_cast< std::add_pointer_t<Pawn*>>(_a[1]))); break;
        case 2: _t->finished((*reinterpret_cast< std::add_pointer_t<Pawn*>>(_a[1]))); break;
        ...
        {
            using _t = void (Track::*)(Pawn * );
            if (_t _q_method = &Track::pawnSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Track::*)(Pawn * );
            if (_t _q_method = &Track::pawnReturned; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Track::*)(Pawn * );
            if (_t _q_method = &Track::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Track::pawnSelected(Pawn * _t1)
{
...
// SIGNAL 1
void Track::pawnReturned(Pawn * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
